...
dataread<-read.csv("E:\\D Drive\\Second Sem\\Project\\petrol price prediction\\petrol5.csv", header = T)

#Loading the dataset
data <- read.csv("E:\\D Drive\\Second Sem\\Project\\petrol price prediction\\dataset\\Petrol Price Original.csv", header = T)
datapp <-read.csv("E:\\D Drive\\Second Sem\\Project\\petrol price prediction\\predicted11.csv", header = T)
